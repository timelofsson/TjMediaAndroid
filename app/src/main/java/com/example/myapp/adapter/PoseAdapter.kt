...
class PoseAdapter(val items : ArrayList<Pose>, val context: Context, val mOnPoseListener: OnPoseListener, val resources : Resources) : RecyclerView.Adapter<PoseAdapter.ViewHolder> () {
